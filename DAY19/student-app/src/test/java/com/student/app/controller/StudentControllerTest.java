...
//    assertEquals("", result);
  ...
  public void testdeleteStudent()throws Exception {
    ResultActions resultActionsDelete = mockMvc.perform(delete("/delete/student")
            .param("name", "student1")
            .accept(MediaType.APPLICATION_JSON));

    resultActionsDelete.andExpect(status().isOk());
    String deleteResult = resultActionsDelete.andReturn().getResponse().getContentAsString();
